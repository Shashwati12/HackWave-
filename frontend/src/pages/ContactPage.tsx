      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20">
        ...
        >
          {cards.map((c, i) => (
            <motion.div
              ...
              className="relative w-full lg:w-64 h-64 rounded-3xl bg-black/40 backdrop-blur-xl border border-[#16D3AC]/30 shadow-[0_0_40px_rgba(22,211,172,0.15)] flex flex-col items-center justify-center p-5 text-center mx-auto"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            ...
            <div className="space-y-4">
              {(showAllFaqs ? faqs : faqs.slice(0, 3)).map((f, idx) => (
                <div
                  ...
                  className={`cursor-pointer select-none bg-black/40 backdrop-blur-xl border border-[#16D3AC]/20 p-4 rounded-2xl transition-all hover:-translate-y-1 hover:shadow-[0_0_40px_rgba(22,211,172,0.15)]`}
                >
          ...
          <motion.section initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.08 }}>
            ...
            <form onSubmit={submit} className="bg-black/40 backdrop-blur-xl border border-[#16D3AC]/20 p-6 rounded-3xl shadow-[0_0_60px_rgba(22,211,172,0.15)]">
